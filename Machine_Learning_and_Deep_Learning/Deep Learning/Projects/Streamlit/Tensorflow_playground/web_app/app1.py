...
# Datasets
data_set = st.sidebar.selectbox('Datasets', ['1.ushape.csv', '2.concerticcir1.csv', '3.concertriccir2.csv', '4.linearsep.csv', '5.outlier.csv', '6.overlap.csv', '7.xor.csv', '8.twospirals.csv', '9.random.csv'])

# Construct the file path
file_path = f"data/{data_set}"

# loading the data
df = pd.read_csv(file_path)

# segregating dat into X and y
X = df.iloc[:, :2].values
y = df.iloc[:, -1].values
